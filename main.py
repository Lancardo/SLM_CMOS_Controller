...
from PyQt6.QtGui import QScreen, QPixmap, QPainter
...
class ImageDisplayWindow(QWidget):
    def __init__(self, image_list=None, interval=5000, camera_manager=None, enable_camera=False, single_image_mode=False, progress_bar=None, target_screen=None):
        super().__init__()
        # 设置窗口属性
        ...
        self.image_label.setScaledContents(True)  # 设置缩放内容以填满标签
        ...
        if self.target_screen:
            ...
            # 设置图片标签大小
            self.image_label.setGeometry(0, 0, screen_geometry.width(), screen_geometry.height())
